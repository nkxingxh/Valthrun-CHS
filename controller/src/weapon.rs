...
define_weapons! {
    ...
    pub enum WeaponId {
        ...
        Famas { id: 10, name: "法玛斯", flags: WEAPON_FLAG_TYPE_RIFLE },
        G3SG1 { id: 11, name: "G3SG1", flags: WEAPON_FLAG_TYPE_SNIPER_RIFLE },
        Galilar { id: 13, name: "加利尔 AR", flags: WEAPON_FLAG_TYPE_RIFLE },
        ...
        Nova { id: 35, name: "新星", flags: WEAPON_FLAG_TYPE_SHOTGUN },
        ...
        Knife { id: 42, name: "匕首", flags: WEAPON_FLAG_TYPE_KNIFE },
        Flashbang { id: 43, name: "闪光弹", flags: WEAPON_FLAG_TYPE_GRANADE },
        HZGranade { id: 44, name: "高爆手雷", flags: WEAPON_FLAG_TYPE_GRANADE },
        SmokeGranade { id: 45, name: "烟雾弹", flags: WEAPON_FLAG_TYPE_GRANADE },
        Molotov { id: 46, name: "燃烧弹 (T)", flags: WEAPON_FLAG_TYPE_GRANADE },
        Decoy { id: 47, name: "诱饵弹", flags: WEAPON_FLAG_TYPE_GRANADE },
        Incendiary { id: 48, name: "燃烧弹", flags: WEAPON_FLAG_TYPE_GRANADE },
        C4 { id: 49, name: "C4", flags: 0 },
        Healthshot { id: 57, name: "治疗剂", flags: 0 },
        KnifeT { id: 59, name: "匕首 (T)", flags: WEAPON_FLAG_TYPE_KNIFE },
        M4A1Silencer { id: 60, name: "M4A1 消音版", flags: WEAPON_FLAG_TYPE_RIFLE },
