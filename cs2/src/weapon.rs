...
define_weapons! {
    ...
    pub enum WeaponId {
        ...
        Flashbang { id: 43, name: "闪光弹", flags: WEAPON_FLAG_TYPE_GRENADE },
        HZgrenade { id: 44, name: "高爆手雷", flags: WEAPON_FLAG_TYPE_GRENADE },
        Smokegrenade { id: 45, name: "烟雾弹", flags: WEAPON_FLAG_TYPE_GRENADE },
        Molotov { id: 46, name: "燃烧弹 (T)", flags: WEAPON_FLAG_TYPE_GRENADE },
        Decoy { id: 47, name: "诱饵弹", flags: WEAPON_FLAG_TYPE_GRENADE },
        Incendiary { id: 48, name: "燃烧弹", flags: WEAPON_FLAG_TYPE_GRENADE },
